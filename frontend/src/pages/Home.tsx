            ...
            <div className="bg-black pb-10 w-full min-h-screen overflow-x-hidden">
                <div className="relative min-h-screen overflow-hidden bg-black text-white">
                    ...
                    <div className="relative z-10 flex flex-col items-center justify-center min-h-screen px-4 sm:px-6 text-center max-w-5xl mx-auto">
                        ...
                        <h1 className="text-2xl sm:text-4xl md:text-5xl lg:text-6xl leading-tight max-w-4xl animate-fade-in-up font-medium bg-gradient-to-r from-white via-purple-200 to-[#d0a2fd] bg-clip-text text-transparent">
                        ...
                        <div className="mt-10 flex flex-col sm:flex-row items-center justify-center gap-4 animate-fade-in-up delay-400">
                            <Button variant={"default"} className="w-full sm:w-40 p-5" asChild>
                                <Link to={"/login"}>
                                    <span className="font-bold flex items-center justify-center gap-2">Get Started <ChevronRight /></span>
                                </Link>
                            </Button>
                        </div>

                        <div className="mt-16 flex flex-row items-center justify-center gap-6 animate-fade-in-up delay-500 max-w-4xl text-center">
                            <div className="flex flex-col items-center gap-3 group">
                                ...
                                <span className="text-sm text-white font-medium">List Item</span>
                            </div>
                            ...
                            <div className="flex flex-col items-center gap-3 group">
                                ...
                                <span className="text-sm text-white font-medium">Browse & Match</span>
                            </div>
                            ...
                            <div className="flex flex-col items-center gap-3 group">
                                ...
                                <span className="text-sm text-white font-medium">Swap & Enjoy</span>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <section className="py-16 bg-black">
                    <div className="max-w-7xl mx-auto px-6 flex flex-col items-center justify-center">
                        ...
                        <div className="w-full grid gap-2 sm:grid-cols-2 lg:grid-cols-3">
                            <div className="glow-border rounded-lgsm:col-span-2 lg:col-span-2">
